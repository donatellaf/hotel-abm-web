...
const FormVendedor = ({ openModal, setOpenModal, initialValues, onSave }) => {
  const [formValues, handleInputChange] = useForm();

  const handleSubmit = (e) => {
    const form = { ...initialValues, ...formValues };
    initialValues
      ? httpPut(`vendedor/${initialValues.id}/`, form)
      : httpPost("vendedor/", form);
  };
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
              <TextField
                ...
                variant="outlined"
                onChange={handleInputChange}
                defaultValue={initialValues?.sueldo}
              />
            </Grid>
            <Grid item xs={12}>
              <TextField
